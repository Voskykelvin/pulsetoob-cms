...
export async function generateMetadata({ params }: AuthorPageProps): Promise<Metadata> {
  ...
  const author = getAuthorFromArticles(articles, params.id)
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <header className="mx-auto max-w-3xl text-center">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full border border-green-100 bg-green-50 text-2xl font-extrabold text-green-700">
